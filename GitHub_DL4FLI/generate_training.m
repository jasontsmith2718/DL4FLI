% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Generates the simulated TPSF voxel data using functions included along with 
% IRF and MNIST data.
% 
...
% Take 28x28 subset of random 32x32 MNIST image
    im_binary = train_images(3:end-2,3:end-2,ceil(rand()*60000));
...
% Generate t1, t2 and AR image maps
    ...
    data = generate_tpsfs(inten, tau1, tau2, ratio, irf_w);
    m = size(im_binary,1);
    n = size(im_binary,2);
